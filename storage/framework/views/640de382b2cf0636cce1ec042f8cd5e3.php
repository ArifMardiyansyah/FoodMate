        ...
        <?php else: ?>
            <div class="space-y-4">
                <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 border <?php echo e($notification->is_read ? 'border-gray-100' : 'border-[#F6A406] bg-orange-50/30'); ?>" data-notification-id="<?php echo e($notification->id); ?>">
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 <?php echo e($notification->is_read ? 'bg-gray-100' : 'bg-gradient-to-br from-[#F6A406] to-[#F08C00]'); ?>">
                                <?php if($notification->type === 'cooking'): ?>
                                    <span class="text-2xl">👨‍🍳</span>
                                <?php elseif($notification->type === 'delivering'): ?>
                                    <span class="text-2xl">🚚</span>
                                <?php elseif($notification->type === 'completed'): ?>
                                    <span class="text-2xl">✅</span>
                                <?php else: ?>
                                    <span class="text-2xl">📦</span>
                                <?php endif; ?>
                            ...
                            <div class="flex-1">
                                <div class="flex items-start justify-between mb-2">
                                    <h3 class="text-lg font-bold text-black"><?php echo e($notification->title); ?></h3>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="text-sm text-gray-500">
                                        <span class="font-semibold">Order #<?php echo e($notification->order->order_number); ?></span>
                                        <span class="mx-2">•</span>
                                        <span><?php echo e($notification->created_at->diffForHumans()); ?></span>
                                    </div>
                                    <?php if(!$notification->is_read): ?>
                                        <button class="mark-read text-sm text-[#F6A406] hover:text-[#F08C00] font-semibold" data-id="<?php echo e($notification->id); ?>">
                                            Tandai Dibaca
                                        </button>
                                    <?php endif; ?>
                                </div>
...
</html><?php /**PATH C:\xampp\htdocs\FoodMate\FoodMate\resources\views/notifications/index.blade.php ENDPATH**/ ?>