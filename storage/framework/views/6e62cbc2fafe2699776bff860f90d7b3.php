<?php $__env->startSection('title', 'Tambah Produk - FoodMate Admin'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <!-- Form -->
    <form action="<?php echo e(route('admin.products.store')); ?>" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm p-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" value="<?php echo e(old('name')); ?>" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#F6A406] focus:border-transparent" placeholder="Contoh: Nasi Goreng Spesial">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="description" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#F6A406] focus:border-transparent" placeholder="Deskripsi produk..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="price" value="<?php echo e(old('price')); ?>" required min="0" step="1000" class="w-full pl-12 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#F6A406] focus:border-transparent" placeholder="25000">
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number" name="rating" value="<?php echo e(old('rating', 0)); ?>" min="0" max="5" step="0.1" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#F6A406] focus:border-transparent" placeholder="4.5">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-3">
                        <input type="checkbox" name="use_stock_system" id="use_stock_system" value="1" <?php echo e(old('use_stock_system') ? 'checked' : ''); ?> class="w-5 h-5 text-[#F6A406] border-gray-300 rounded focus:ring-[#F6A406]">
                    ...
                    <div id="stock_fields" class="space-y-4 <?php echo e(old('use_stock_system') ? '' : 'hidden'); ?>">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Stok Harian Default</label>
                            <input type="number" name="default_daily_stock" value="<?php echo e(old('default_daily_stock', 0)); ?>" min="0" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#F6A406] focus:border-transparent" placeholder="50">
                        ...
                        <div>
                            ...
                            <input type="number" name="minimum_stock" value="<?php echo e(old('minimum_stock', 5)); ?>" min="0" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#F6A406] focus:border-transparent" placeholder="5">
            ...
            <div class="border-t border-gray-200 pt-6">
                <div class="flex items-center gap-3">
                    <input type="checkbox" name="is_active" id="is_active" value="1" <?php echo e(old('is_active', true) ? 'checked' : ''); ?> class="w-5 h-5 text-[#F6A406] border-gray-300 rounded focus:ring-[#F6A406]">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\FoodMate\FoodMate\resources\views/admin/products/create.blade.php ENDPATH**/ ?>