                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 sticky top-6">
                        ...
                        <div class="space-y-4 mb-6 max-h-64 overflow-y-auto">
                            ...
                            <div class="flex items-center gap-3 pb-4 border-b border-gray-100">
                                <div class="w-16 h-16 bg-gray-200 rounded-lg overflow-hidden flex-shrink-0">
                                    <img src="<?php echo e(asset($item['image'])); ?>" alt="<?php echo e($item['name']); ?>" class="w-full h-full object-cover">
                                </div>
                                <div class="flex-1 min-w-0">
                                    <h4 class="font-semibold text-black text-sm truncate"><?php echo e($item['name']); ?></h4>
                                    <p class="text-sm text-gray-500"><?php echo e($item['quantity']); ?>x <?php echo e($item['price']); ?></p>
                                </div>
                                <div class="text-sm font-bold text-[#f97316]">
                                    Rp. <?php echo e(number_format($item['price_numeric'] * $item['quantity'])); ?>
                        ...
                        <div class="space-y-3 mb-6">
                            <div class="flex justify-between text-gray-600">
                                <span>Sub-Total</span>
                                <span class="font-semibold">Rp. <?php echo e(number_format($subtotal)); ?></span>
                            </div>
                            <div class="flex justify-between text-gray-600">
                                <span>Biaya Pengiriman</span>
                                <span class="font-semibold">Rp. <?php echo e(number_format($deliveryCharge)); ?></span>
                            </div>
                            <?php if($discount > 0): ?>
                            <div class="flex justify-between text-green-600">
                                <span>Diskon</span>
                                <span class="font-semibold">-Rp. <?php echo e(number_format($discount)); ?></span>
                            </div>
                            <?php endif; ?>
                            <hr class="border-gray-200">
                            <div class="flex justify-between text-xl font-bold text-black">
                                <span>Total</span>
                                <span class="text-[#f97316]">Rp. <?php echo e(number_format($total)); ?></span>
                            </div>
                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\FoodMate\FoodMate\resources\views/checkout.blade.php ENDPATH**/ ?>