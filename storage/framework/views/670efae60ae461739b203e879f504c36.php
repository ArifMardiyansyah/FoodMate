...
<head>
    ...
    <title><?php echo e(config('app.name', 'FoodMate')); ?> - Mudah Pesan Nikmat Diantar</title>
            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="relative">
                    <button id="account-btn" type="button" class="bg-white text-gray-700 p-3 rounded-full shadow-sm border focus:outline-none focus:ring-2 focus:ring-orange-400">
                        <img src="<?php echo e(asset('images/icon/account.png')); ?>"
                             alt="User Account"
                             class="w-6 h-6">
                    </button>
            ...
            <div class="grid gap-8 md:grid-cols-3">
                ...
                <div class="bg-yellow-400 rounded-xl p-6 text-center">
                    <div class="w-12 h-12 bg-yellow-400 rounded-full flex items-center justify-center mx-auto mb-4">
                        <img src="<?php echo e(asset('images/icon/discount (1).png')); ?>"
                             alt="Discount"
                             class="w-12 h-12">
                    </div>
                ...
                <div class="bg-yellow-400 rounded-xl p-6 text-center">
                    <div class="w-12 h-12 bg-yellow-400 rounded-full flex items-center justify-center mx-auto mb-4">
                        <img src="<?php echo e(asset('images/icon/rush (1).png')); ?>"
                             alt="Fast Service"
                             class="w-15 h-15">
                    </div>
                ...
                <div class="bg-yellow-400 rounded-xl p-6 text-center">
                    <div class="w-12 h-12 bg-yellow-400 rounded-full flex items-center justify-center mx-auto mb-4">
                        <img src="<?php echo e(asset('images/icon/fresh (1).png')); ?>"
                             alt="Fresh Food"
                             class="w-12 h-12">
                    </div>
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="bg-white rounded-2xl p-4 shadow-lg">
                    <div class="w-90 h-70 bg-gray-100 rounded-xl mb-4 overflow-hidden">
                        <img src="<?php echo e(asset('images/food/pecel_ayam.png')); ?>"
                             alt="Pecel Ayam"
                ...
                <div class="bg-white rounded-2xl p-4 shadow-lg">
                    <div class="w-full h-70 bg-gray-100 rounded-xl mb-4 overflow-hidden">
                        <img src="<?php echo e(asset('images/food/pecel_lele.png')); ?>"
                             alt="Pecel Lele"
                             class="w-full h-full object-cover">
                    </div>
                ...
                <div class="bg-white rounded-2xl p-4 shadow-lg">
                    <div class="w-full h-70 bg-gray-100 rounded-xl mb-4 overflow-hidden">
                        <img src="<?php echo e(asset('images/food/nasi_goreng.png')); ?>"
                             alt="Nasi Goreng"
                             class="w-full h-full object-cover">
                    </div>
                ...
                <!-- Gado Gado -->
                    <div class="bg-white rounded-2xl p-4 shadow-lg">
                    <div class="w-full h-70 bg-gray-100 rounded-xl mb-4 overflow-hidden">
                        <img src="<?php echo e(asset('images/food/gado_gado.png')); ?>"
                             alt="Gado Gado"
                             class="w-full h-full object-cover">
                    </div>
                ...
                <div class="bg-white rounded-2xl p-4 shadow-lg">
                    <div class="w-full h-70 bg-gray-100 rounded-xl mb-4 overflow-hidden">
                        <img src="<?php echo e(asset('images/food/nasi_uduk.png')); ?>"
                             alt="Nasi Goreng"
                             class="w-full h-full object-cover">
                    </div>
    ...
    <div class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-6 md:grid-cols-3 max-w-4xl mx-auto">
                ...
                <div class="bg-white rounded-2xl p-4 shadow-lg">
                    <div class="w-full h-70 bg-gray-100 rounded-xl mb-4 overflow-hidden">
                        <img src="<?php echo e(asset('images/drink/es_teh_hijau.png')); ?>"
                             alt="Es Teh Hijau"
                             class="w-full h-full object-cover">
                    </div>
                ...
                <div class="bg-white rounded-2xl p-4 shadow-lg">
                    <div class="w-full h-70 bg-gray-100 rounded-xl mb-4 overflow-hidden">
                        <img src="<?php echo e(asset('images/drink/susu_kedelai.png')); ?>"
                             alt="Susu Kedelai"
                             class="w-full h-full object-cover">
                    </div>
                ...
                <div class="bg-white rounded-2xl p-4 shadow-lg">
                    <div class="w-full h-70 bg-gray-100 rounded-xl mb-4 overflow-hidden">
                        <img src="<?php echo e(asset('images/drink/esteh.png')); ?>"
                             alt="Nasi Goreng"
                             class="w-full h-full object-cover">
                    </div>
            ...
            <div class="grid gap-8 md:grid-cols-3 max-w-5xl mx-auto">
                ...
                <div class="bg-white rounded-2xl p-6 text-center shadow-lg">
                    <div class="w-20 h-20 bg-yellow-400 rounded-full mx-auto mb-4 flex items-center justify-center overflow-hidden">
                        <img src="<?php echo e(asset('images/icon/man.png')); ?>"
                             alt="Budi"
                ...
                <div class="bg-white rounded-2xl p-6 text-center shadow-lg">
                    <div class="w-20 h-20 bg-red-400 rounded-full mx-auto mb-4 flex items-center justify-center overflow-hidden">
                        <img src="<?php echo e(asset('images/icon/woman.png')); ?>"
                             alt="Suci"
                             class="w-16 h-16 object-cover">
                    </div>
    ...
    <footer id="contact" style="background-color: #f6a406;" class="text-white">
        <div class="w-full px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between py-4">
                <div class="flex items-center">
                    <img src="<?php echo e(asset('images/logo/logo1.png')); ?>" alt="FoodMate Logo" class="w-30 h-20 mr-2">
...
<?php /**PATH C:\xampp\htdocs\FoodMate\FoodMate\resources\views/welcome.blade.php ENDPATH**/ ?>