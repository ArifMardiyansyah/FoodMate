        ...
        <form action="/register" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input
                    ...
                    class="w-full bg-gray-100 rounded-lg py-4 px-5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FF8C42] focus:bg-white transition-all <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input
                    ...
                    class="w-full bg-gray-100 rounded-lg py-4 px-5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FF8C42] focus:bg-white transition-all <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
            ...
            <div>
                ...
                <div class="relative">
                    <input
                        ...
                        type="password"
                        placeholder="••••••••"
                        class="w-full bg-gray-100 rounded-lg py-4 px-5 pr-12 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FF8C42] focus:bg-white transition-all <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
...
</html><?php /**PATH C:\xampp\htdocs\FoodMate\FoodMate\resources\views/auth/register.blade.php ENDPATH**/ ?>