                ...
                <div class="order-summary animate-fade-in-up" style="animation-delay: 0.3s;">
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Nomor Pesanan: <span class="font-semibold text-gray-900"><?php echo e($order->order_number); ?></span></p>
                            <p class="text-xs text-gray-400"><?php echo e($order->created_at?->timezone('Asia/Jakarta')->format('d M Y, H:i')); ?></p>
                        </div>
                        <div class="text-right">
                            <span class="text-xs uppercase tracking-wide text-gray-500">Total</span>
                            <div class="text-2xl font-bold text-[#FF6600]">Rp. <?php echo e(number_format($order->total)); ?></div>
                        </div>
                    </div>
                    <div class="info-row">
                    ...
                    <div class="info-row">
                        ...
                        <span class="text-right max-w-xs"><?php echo e($order->customer_address); ?></span>
                    </div>
                    <div class="info-row">
                        <span>Metode Pembayaran</span>
                        <span class="capitalize"><?php echo e($order->payment_method); ?></span>
                    </div>
                    <?php if($order->notes): ?>
                        <div class="info-row">
                            <span>Catatan</span>
                            <span class="text-right max-w-xs"><?php echo e($order->notes); ?></span>
                        </div>
                    <?php endif; ?>
                            ...
                            <div class="order-item">
                                <div class="flex items-center">
                                    ...
                                    <div class="details">
                                        ...
                                        <p><?php echo e($item->quantity); ?> x Rp. <?php echo e(number_format($item->product_price)); ?></p>
                                    </div>
                                </div>
                                <div class="total">Rp. <?php echo e(number_format($item->total)); ?></div>
                            </div>
        ...
        function orderFeedback() {
            return {
                ...
                async submitFeedback() {
                    ...
                    try {
                        const response = await fetch('<?php echo e(route("order-feedback.submit")); ?>', {
                            method: 'POST',
                            headers: {
...
<?php /**PATH C:\xampp\htdocs\FoodMate\FoodMate\resources\views/order/completed.blade.php ENDPATH**/ ?>